...
export const categories: Category[] = [
  {
    ...
    links: [
      ...
      { name: 'Endpoints - LCD - Public Node', url: 'https://terra-classic-lcd.publicnode.com', description: 'LCD Endpoint', indicator: 'support' },
      ...
      { name: 'Endpoints - RPC - Public Node', url: 'https://terra-classic-rpc.publicnode.com', description: 'RPC Endpoint', indicator: 'support' },
      ...
      { name: 'Endpoints - FDC - Public Node', url: 'https://terra-classic-fcd.publicnode.com', description: 'FCD Endpoint', indicator: 'support' },
