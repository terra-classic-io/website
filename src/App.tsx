        ...
        <main className="flex-1">
          ...
          <section className="bg-white dark:bg-gray-800 py-12 transition-colors duration-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                ...
                <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 dark:text-white dark:text-opacity-80 sm:mt-4 transition-colors duration-200">
          ...
          <div className="grid grid-cols-1 gap-8 pt-4">
            {categories.map(cat => (
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-terra-blue dark:hover:border-terra-green">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-12 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                {categories.map((category) => (
                    ...
                    <CategorySection category={category} key={category.title} />
