...
const footerGroups = [
  {
    ...
    links: [
      ...
      { label: "Project map", href: "/bubbles" },
  ...
  },
  {
    title: "Community",
    links: [
      { label: "Forum", href: "https://discourse.luncgoblins.com" },
      { label: "Validator resources", href: "/bubbles?cat=validators" },
      { label: "Information", href: "/bubbles?cat=blockchain-information" },
      { label: "Wallets", href: "/bubbles?cat=wallets" },
    ],
  },
  {
    title: "Resources",
    links: [
      ...
      { label: "Ecosystem directory", href: "/bubbles" },
      { label: "Project map", href: "/bubbles" },
    ],
  },
] as const;
      ...
      <div className="mx-auto grid max-w-[1480px] gap-10 px-5 py-12 sm:px-8 lg:grid-cols-[1.3fr_repeat(3,0.75fr)_1.2fr] lg:px-10">
        <div>
          ...
          <div className="mt-5 flex items-center gap-2">
            <a href="https://github.com/terra-classic-io/website" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="footer-social"><Github size={16} /></a>
            <a href="https://discourse.luncgoblins.com" target="_blank" rel="noopener noreferrer" aria-label="Community forum" className="footer-social"><MessageCircle size={16} /></a>
            <a href="https://t.me/classicluna" target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="footer-social"><Send size={16} /></a>
          </div>
        </div>
        ...
        <div>
          ...
          <a
            href="https://discourse.luncgoblins.com"
            target="_blank"
