...
const activeClassname: string = 'border-sky-300 bg-sky-200 text-slate-600 shadow-lg shadow-sky-500/30 dark:border-sky-500 dark:bg-sky-500/80 dark:text-slate-200';
