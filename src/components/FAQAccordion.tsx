...
const FAQAccordion: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: (
        <>
          <p>
            To stake LUNC, connect a wallet such as `Keplr`, `Galaxy Station`, or `Cosmostation`, choose a validator, and delegate tokens. Staking APR moves with governance parameters and network usage, so check the live network rate shown above before delegating.
          </p>
          <p>
  ...
  return (
    <section className="py-12 mt-8 border-t border-gray-200 dark:border-gray-700">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-8">Get answers to common questions about the Terra Classic network, LUNC, USTC, staking, governance, and wallets.</p>
